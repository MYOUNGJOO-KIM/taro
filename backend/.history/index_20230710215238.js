...
app.post('/fortuneTell', async function (req, res) {
    ...
    const completion = await openai.createChatCompletion({
        ...
        messages: [
            ...
            {role: "user", content: name+" 최대한 구체적으로 상황을 좋은일, 좋지 않은 일로 나누어서 예시로 들어서 대답해줘. 그리고 내가 내일 아침에 무슨 생각을 하면서 눈을 뜨면 되는지도 알려줘. '더 궁금한 점이 있으면 언제든지 물어봐주세요! 저는 여러분을 도울 준비가 되어 있어요.' 이런말은 하지마."}
