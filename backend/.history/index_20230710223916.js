...
app.post('/fortuneTell', async function (req, res) {
    ...
    const completion = await openai.createChatCompletion({
        ...
        messages: [
            ...
            {role: "user", content: name+" '가족운', '건강운', '사업운', '이사운', '연애운' 이 5가지의 운 중에 조심해야 할 운을 너의 점성술을 이용해서 대답해줘. 그리고 너가 말해준 조심해야할 운을 극복하기 위해 내가 내일 아침에 어떤 물건을 생각을 하면서 눈을 뜨면 되는지도 알려줘. '더 궁금한 점이 있으면 언제든지 물어봐주세요! 저는 여러분을 도울 준비가 되어 있어요.' 이런말은 하지마."}
